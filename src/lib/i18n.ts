...
const messages: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'wechat.title': '微信远程终端',
    'wechat.subtitle': '绑定后，微信消息会进入当前桌面 Claude Code 会话，桌面应用仍然负责运行 agent。',
  ...
  en: {
    ...
    'wechat.subtitle': 'After binding, WeChat messages enter the current desktop Claude Code session while the desktop app keeps owning the agent runtime.',
