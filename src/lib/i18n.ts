...
const messages: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'settings.tab.wechat': '微信',
    'settings.tab.feedback': '反馈',
    'settings.footer.changelog': '更新日志',
    'settings.footer.checkUpdate': '检查更新',
    'settings.footer.upToDate': '已是最新',
    'wechat.title': '微信远程终端',
    'wechat.subtitle': '绑定后，微信消息会进入绑定工作区的「微信接入」固定会话，桌面应用仍然负责运行 agent。',
    'wechat.connected': '已连接',
    'wechat.disconnected': '未连接',
    'wechat.sessionExpired': '微信会话已过期',
    'wechat.sessionExpiredDetail': '微信登录态已过期，后台轮询已暂停。请重新扫码连接。',
    'wechat.noAccount': '尚未绑定微信账号',
    'wechat.connect': '连接微信',
    'wechat.connecting': '连接中…',
    'wechat.disconnect': '断开连接',
    'wechat.waiting': '等待扫码确认',
    'wechat.scanned': '已扫码，等待确认',
    'wechat.waitingDetail': '请在微信中扫码并确认绑定。',
    'wechat.qrExpiresIn': '约 {seconds} 秒后过期。',
    'wechat.qrExpiredHint': '二维码已过期，请刷新。',
    'wechat.refreshQr': '刷新二维码',
    'wechat.copyQrLink': '复制链接',
    'wechat.copyQrLinkDone': '登录链接已复制',
    'wechat.qrAlt': '微信登录二维码',
    'wechat.workspaceBinding': '绑定工作区',
    'wechat.workspaceBindingDetail': '微信消息会进入 {workspace} 的「微信接入」会话。',
    'wechat.workspaceBindingEmpty': '选择一个工作区后，微信消息会固定进入那个工作区的「微信接入」会话。',
    'wechat.followCurrentWorkspace': '跟随当前工作区',
    'wechat.workspaceFixedMode': '固定到某个项目',
  ...
  en: {
    ...
    'wechat.title': 'WeChat Remote Terminal',
    'wechat.subtitle': 'After binding, WeChat messages enter the fixed WeChat session for the bound workspace while the desktop app keeps owning the agent runtime.',
    'wechat.connected': 'Connected',
    'wechat.disconnected': 'Disconnected',
    'wechat.sessionExpired': 'WeChat session expired',
    'wechat.sessionExpiredDetail': 'The WeChat login session expired and polling is paused. Scan a new QR code to reconnect.',
    'wechat.noAccount': 'No WeChat account bound',
    'wechat.connect': 'Connect WeChat',
    'wechat.connecting': 'Connecting…',
    'wechat.disconnect': 'Disconnect',
    'wechat.waiting': 'Waiting for QR confirmation',
    'wechat.scanned': 'Scanned, waiting for confirmation',
    'wechat.waitingDetail': 'Scan and confirm the binding in WeChat.',
    'wechat.qrExpiresIn': 'Expires in about {seconds}s.',
    'wechat.qrExpiredHint': 'QR code expired. Refresh it.',
    ...
    'wechat.workspaceBinding': 'Bound workspace',
    'wechat.workspaceBindingDetail': 'WeChat messages enter the fixed WeChat session in {workspace}.',
    'wechat.workspaceBindingEmpty': 'Choose a workspace so WeChat messages always enter that workspace’s fixed WeChat session.',
    'wechat.followCurrentWorkspace': 'Follow current workspace',
    'wechat.workspaceFixedMode': 'Fixed project',
